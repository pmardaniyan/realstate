(function ($) {
    ...
    function mainMap() {
        function locationData(locationURL, locationCategory, locationImg, locationTitle, locationAddress,     locationPrice , locationStatus) {
            return ('<div class="map-popup-wrap"><div class="map-popup"><div class="map-popup-status mp-cat  color-bg">' + locationStatus + '</div><div class="map-popup-category mp-cat  color-bg">' + locationCategory + '</div><div class="infoBox-close"><i class="fal fa-times"></i></div> <a href="' + locationURL + '" class="listing-img-content" style="background-image: url(' + locationImg + ')"> </a> <div class="listing-content">  <div class="listing-title">   <h4><a href=' + locationURL + '>' + locationTitle + '</a></h4><span class="map-popup-location-info"> ' + locationAddress + '</span> </div><span class="map-popup-price fl-wrap">  ' + locationPrice + ' تومان  </span></div>    </div></div>')
        }
		 //   locations ------------------
        var locations = [
            [locationData('listing-single2.html', 'آپارتمان', 'images/all/3.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",  "600.000" , "فروش"), 40.72956781, -73.99726866, 0, markerIcon],
            [locationData('listing-single.html', 'آپارتمان', 'images/all/1.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",  "320.000" , "فروش"), 40.76221766, -73.96511769, 1, markerIcon],
            [locationData('listing-single.html', 'خانه', 'images/all/9.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",    "700/در ماه" , "اجاره"), 40.88496706, -73.88191222, 2, markerIcon],
            [locationData('listing-single.html', 'خانه', 'images/all/6.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",   "1,600.000" , "فروش"), 40.72228267, -73.99246214, 3, markerIcon],
            [locationData('listing-single.html', 'ویلا', 'images/all/5.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",   "500.000" , "فروش"), 40.94982541, -73.84357452, 4, markerIcon],
            [locationData('listing-single.html', 'آپارتمان', 'images/all/8.jpg', ' خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",   "700/در ماه" , "اجاره"), 40.90261483, -74.15737152, 5, markerIcon],
            [locationData('listing-single.html', 'آپارتمان', 'images/all/4.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا ",   "700/در ماه" , "اجاره"), 40.79145927, -74.08252716, 6, markerIcon],
            [locationData('listing-single2.html', 'هتل', 'images/all/25.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",     "1.200.000" , "فروش"), 40.58423508, -73.96099091, 7, markerIcon],
            [locationData('listing-single2.html', 'دفتر', 'images/all/7.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",     "700/در ماه" , "اجاره"), 40.58110616, -73.97678375, 8, markerIcon],
            [locationData('listing-single3.html', 'هتل', 'images/all/27.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا", "700/در ماه" , "اجاره"), 40.73112881, -74.07897948, 9, markerIcon],
            [locationData('listing-single3.html', 'دفتر', 'images/all/3.jpg', 'خانه شیک برای فروش', "خیابان مونتگومری، نیویورک، ایالات متحده آمریکا",   "800.000" , "فروش"), 40.67386831, -74.10438536, 10, markerIcon],
        ];
	    //   Map Infoboxes end ------------------
